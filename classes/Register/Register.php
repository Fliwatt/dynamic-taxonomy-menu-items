...
class DynTaxMI_Register_Register {
	 ...
	 */
	protected static $register = 'DynTaxMI_Register_Register';
	/**
	 * @since 20170318
...
//	private static function our_email() { return ( ( mt_rand( 1, 10 ) > 5 ) ? self::$rc_email : self::$jg_email ); }
	...
	public static function unsupported_php_version() {
		$short = __( 'You are running an unsupported version of PHP.', 'dyntaxmi' );
	...
	public static function unsupported_wp_version() {
		$short = __( 'You are running an unsupported version of WordPress.', 'dyntaxmi' );
	...
	private static function display_admin_notice( $short, $long ) {
		...
		<div class="notice notice-error">
			<p style="max-width:800px;">
				<b><?php echo esc_html( sprintf( _x( '%s can not be activated.', 'Plugin title', 'dyntaxmi' ), static::$title ) ); ?></b>
